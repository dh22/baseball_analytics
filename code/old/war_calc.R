...
get_package(c("dplyr","openWAR"))

#read-in maps
load(file="./mapping/map_age.RData") #13-56 w/ positions - need to go back and fix this dataset
load(file="./mapping/map_team_league.RData")

#read datasets 
load(file="./trn/leagueavg.RData") #goes back 146 yrs
load(file="./trn/alnl_league.RData")#2005-2015
load(file="./trn/parkfactors.RData")#2005-2015
